...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ArabLeagueCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ArabLeagueCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("ArabLeagueCoin-start");
