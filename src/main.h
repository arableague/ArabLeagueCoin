...
static const uint256 hashGenesisBlock("0x00000fe65447742af1d903708f5f6e05b65e1da5891474fa459c42519608a795");
static const uint256 hashGenesisBlockTestNet("0x00000fe65447742af1d903708f5f6e05b65e1da5891474fa459c42519608a795");
...
public:
    ...
    {
        // ArabLeagueCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // ArabLeagueCoin: get transaction coin age
...
public:
    ...
    // ArabLeagueCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // ArabLeagueCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // ArabLeagueCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // ArabLeagueCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // ArabLeagueCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // ArabLeagueCoin: block index flags
    enum  
    {
